sap.ui.jsview("utg.ams.sd.view.xsjs", {

    getControllerName : function() {
       return "utg.ams.sd.controller.xsjs";
     },
     ...
     createContent : function(oController) {
          ...
          oVal1.attachEvent("liveChange", function(){
               oController.onLiveChange1(); });  
          //Attach a controller event handler to Value 2 Input Field
          oVal2.attachEvent("liveChange", function(){
               oController.onLiveChange1(); });  	      
